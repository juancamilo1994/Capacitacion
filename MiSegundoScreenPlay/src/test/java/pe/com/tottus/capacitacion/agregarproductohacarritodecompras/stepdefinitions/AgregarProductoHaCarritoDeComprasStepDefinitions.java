...
public class AgregarProductoHaCarritoDeComprasStepDefinitions {
	...
	@When("^Agrega el pruducto \"([^\"]*)\" al carrito de compras$")
	public void agregaElPruductoAlCarritoDeCompras(String producto) throws Exception {
	...
	@Then("^Deberia ver el producto \"([^\"]*)\" agregado en el carrito de compras$")
	public void deberiaVerElProductoAgregadoEnElCarritoDeCompras(String nombreDelProducto) throws Exception {
		//Se valida que el producto este en el carrito comparando el texto
		System.out.println(nombreDelProducto);//se imprime el parametro que se evia desde elFeature para validar que si se este generando corrcetamente
		...
		juancamilo.should(seeThat(ValidarProducto.enElCarrito(),equalTo(nombreDelProducto)));
